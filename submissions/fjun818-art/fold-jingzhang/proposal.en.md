...
**Within-plan-area (16.7 km²) mutually-exclusive allocation:**
...
| **In-plan-area total** | **2108** | **100%** | Mutually-exclusive zones sum to 2108 ≤ the 24.08M sqm plan ceiling (pending registry) |
...
| Art. 7 | Pop. 364k / jobs 397k / ceiling 24.08M sqm | Baselines as hard constraints and scenario basis | population/employment/total-floor metrics | Pending registry (plan-text constant) |
